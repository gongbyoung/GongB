...
window.ENGINES = {
    ...
    sakura: (pg, t, b, p1, p2, p3) => {
        ...
        for(let i=0; i<p1/2; i++){ 
            pg.push(); 
            pg.translate(p5.prototype.noise(i)*1000-500, (t*200+i*50)%1000-500); 
