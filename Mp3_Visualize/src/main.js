...
window.addEventListener('DOMContentLoaded', () => {
    ...
    link.rel = 'stylesheet';
    link.href = link.href = 'https://fonts.googleapis.com/css2?family=Black+Han+Sans&family=Noto+Sans+KR:wght@500;900&display=swap';
    document.head.appendChild(link);
    
    // 💡 [TypeError 버그 완전 치료]: 녹화에 제외되는 모니터링 HUD의 메모리 진단 방어 코드 시공
    ...
    setInterval(() => {
        ...
        // 💡 브라우저 환경에 따라 usedJSHeapSize가 undefined인 경우 방어 처리 (TypeError 원천 봉쇄)
